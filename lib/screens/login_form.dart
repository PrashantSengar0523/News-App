    ...
    return Column(
      ...
      children: [
        ...
        InkWell(
          ...
          child: Center(child: Text("Forgot Password?",style: TextStyle(fontFamily: 'Regular',fontSize: Responsive.getWidth(context)*0.045, color: TColors.primary),textAlign: TextAlign.end,))),
